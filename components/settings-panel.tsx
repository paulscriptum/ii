...
import { Settings, Eye, EyeOff, Save, Server, Key, X } from "lucide-react"
...
export function SettingsPanel({
  ...
  const needsSetup = !initialUrl || !initialToken
  const [open, setOpen] = useState(needsSetup)
  const [url, setUrl] = useState(initialUrl || "ws://217.25.94.44:18789")
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative">
            <input
              ...
              onKeyDown={handleKeyDown}
              placeholder="Token from OpenClaw config.yml"
