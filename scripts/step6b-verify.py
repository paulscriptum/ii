...
print("\n[3] Curl test localhost:")
print(run("curl -s -m 5 http://127.0.0.1:18789/__openclaw__/canvas/ | head -5 || echo 'FAIL'"))

print("\n[4] Curl test 0.0.0.0:")
print(run("curl -s -m 5 http://0.0.0.0:18789/__openclaw__/canvas/ | head -5 || echo 'FAIL'"))
